...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "狀態"),
        ("Your Desktop", "盛群資訊專用遠端協助工具"),
        ("desk_tip", "提供以下ID及密碼即可遠端協助維護電腦"),
        ("Password", "密碼"),
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 盛群資訊 網路..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Key mismatch", "金鑰不符"),
        ("Timeout", "逾時"),
        ("Failed to connect to relay server", "無法連線到盛群資訊專用伺服器"),
        ("Failed to connect via rendezvous server", "無法透過 ID 伺服器連線"),
        ("Failed to connect via relay server", "無法透過盛群遠端資訊伺服器連線"),
        ("Failed to make direct connection to remote desktop", "無法直接連線到遠端桌面"),
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC安全性限制會導致 遠端工具 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 遠端工具 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Click to download", "點選以下載"),
        ("Click to update", "點選以更新"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 盛群遠端維護工具「無障礙功能」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 盛群遠端維護工具「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("setup_server_tip", "此遠端工具僅供盛群資訊遠端維修專用"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 盛群遠端維護工具 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「盛群遠端維護工具 Input」服務。"),
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep RustDesk background service", "保持 盛群遠端維護工具 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 盛群遠端維護工具 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」"),
        ("Start on boot", "開機時啟動"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 盛群遠端維護工具「輸入監控」權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 盛群遠端維護工具「錄音」權限。"),
        ...
        ("still_click_uac_tip", "依然需要遠端使用者在執行 盛群遠端維護工具 時於 UAC 視窗點選「是」。"),
        ...
        ("verify_rustdesk_password_tip", "驗證 盛群遠端維護工具 密碼"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "您可能遭遇詐騙！"),
        ("scam_text1", "如果您正在和素不相識的人通話，而對方要求您使用 盛群遠端維護工具 啟用服務，請勿繼續操作並立即掛斷電話。"),
        ...
        ("selinux_tip", "SELinux 處於啟用狀態，盛群遠端維護工具 可能無法作為被控端正常運作。"),
        ("Change view", "更改檢視方式"),
        ("Big tiles", "大磁磚"),
        ("Small tiles", "小磁磚"),
        ("List", "清單"),
        ...
        ("allow-only-conn-window-open-tip", "只在 盛群遠端維護工具 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 盛群遠端維護工具 後台服務"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "請將盛群遠端維護工具 客戶端升級到 {} 或更新版本！"),
