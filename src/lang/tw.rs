...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Key mismatch", "金鑰不符"),
        ("Timeout", "逾時"),
        ("Failed to connect to relay server", "無法連線到小嘉專用伺服器"),
        ("Failed to connect via rendezvous server", "無法透過 ID 伺服器連線"),
        ("Failed to connect via relay server", "無法透過小嘉專用伺服器連線"),
        ("Failed to make direct connection to remote desktop", "無法直接連線到遠端桌面"),
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC安全性限制會導致 RustDesk 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 RustDesk 安裝到系統中。"),
        ...
        ("setup_server_tip", "此遠端工具僅供邱小嘉遠端維修專用"),
